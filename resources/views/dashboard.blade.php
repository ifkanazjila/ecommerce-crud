...
<body class="bg-gray-50">
    ...
    <div id="completionTimeMsg"
        class="fixed top-5 right-5 z-50 hidden bg-green-100 text-green-800 px-4 py-3 rounded-lg shadow-lg border border-green-300 transition-all duration-300">
    </div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center mb-2">
                                ...
                                <div class="flex text-yellow-400">
                                    ...
                                    @for ($i = 1; $i <= 5; $i++)
                                        <i
                                            class="fas fa-star {{ $i <= floor($product['rating']) ? '' : 'text-gray-300' }}">
                                        </i>
                                    @endfor
    ...
    <footer class="bg-gray-800 text-white py-12">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="border-t border-gray-700 mt-8 pt-8 text-center text-gray-300">
                <p>
                    &copy; 2024 ShopMart. Semua hak dilindungi.
                </p>
            </div>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="text-xs text-gray-600 mt-2">
                                        Waktu eksekusi:
                                        ${data.completion_time.toFixed(4)} detik
                                    </div>
